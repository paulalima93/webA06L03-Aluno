...
function showResult() {
    ...
    if (adicione_aqui_a_condição) { //TODO - se o usuário marcar mais que 3 pontos
    ...
    else if (adicione_aqui_a_condição) { //TODO -  se o usuário marcar mais que 1 ponto
        //TODO - complete, usando o escopo do primeiro if como exemplo

    }
    else { // se o usuário marcar menos que 2 pontos
        //TODO - complete, usando o escopo do primeiro if como exemplo
...
function startTimer(time) {
    ...
    function timer() {
       ...
       //TODO - adicione as condicionais e o loop for
        ...
        if (adicione_aqui_a_condição) { // se o temporizador for menor que 0
            clearInterval(counter); // limpar contador
